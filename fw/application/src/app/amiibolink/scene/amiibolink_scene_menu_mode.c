...
void amiibolink_scene_menu_mode_on_enter(void *user_data) {
    ...
    mui_list_view_add_item(app->p_list_view, ICON_BACK, ">>Volver<<", (void *)-1);

    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modo aleatorio(Manual)", (void *)BLE_AMIIBOLINK_MODE_RANDOM);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modo aleatorio(Automático)",
                           (void *)BLE_AMIIBOLINK_MODE_RANDOM_AUTO_GEN);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modo ordenado", (void *)BLE_AMIIBOLINK_MODE_CYCLE);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Leer y escribir", (void *)BLE_AMIIBOLINK_MODE_NTAG);
