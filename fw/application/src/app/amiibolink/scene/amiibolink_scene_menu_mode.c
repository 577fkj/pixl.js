...
void amiibolink_scene_menu_mode_on_enter(void *user_data) {
    ...
    mui_list_view_add_item(app->p_list_view, ICON_BACK, ">>ritorno<<", (void *)-1);

    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modalità casuale(Manuale)",
                           (void *)BLE_AMIIBOLINK_MODE_RANDOM);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modalità casuale(Auto)",
                           (void *)BLE_AMIIBOLINK_MODE_RANDOM_AUTO_GEN);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modalità sequenziale", (void *)BLE_AMIIBOLINK_MODE_CYCLE);
    mui_list_view_add_item(app->p_list_view, ICON_MODE, "Modalità lettura-scrittura", (void *)BLE_AMIIBOLINK_MODE_NTAG);
