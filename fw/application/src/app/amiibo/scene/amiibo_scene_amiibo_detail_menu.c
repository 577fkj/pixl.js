...
static void amiibo_scene_amiibo_detail_no_key_msg(app_amiibo_t *app) {
    mui_msg_box_set_header(app->p_msg_box, "Chiave Amiibo non caricata");
    mui_msg_box_set_message(app->p_msg_box,
                            "Carica chiave file key_fetail.bin\nnella directory principale dello storage.");
    mui_msg_box_set_btn_text(app->p_msg_box, NULL, "Ho capito", NULL);
...
static void amiibo_scene_amiibo_detail_menu_on_selected(mui_list_view_event_t event, mui_list_view_t *p_list_view,
    ...
    case AMIIBO_DETAIL_MENU_AUTO_RAND_UID: {
        ...
        sprintf(txt, "Random automatica [%s]", p_settings->auto_gen_amiibo ? "aperto" : "chiudi");
        settings_save();
...
void amiibo_scene_amiibo_detail_menu_on_enter(void *user_data) {
    ...
    mui_list_view_add_item(app->p_list_view, 0xe1c5, "Generazione casuale", (void *)AMIIBO_DETAIL_MENU_RAND_UID);
    ...
    mui_list_view_add_item(app->p_list_view, 0xe1c7, "elimina un tocco", (void *)AMIIBO_DETAIL_MENU_REMOVE_AMIIBO);
    mui_list_view_add_item(app->p_list_view, 0xe068, "Torna ai dettagli",
                           (void *)AMIIBO_DETAIL_MENU_BACK_AMIIBO_DETAIL);
    mui_list_view_add_item(app->p_list_view, 0xe069, "Elenco file", (void *)AMIIBO_DETAIL_MENU_BACK_FILE_BROWSER);
    mui_list_view_add_item(app->p_list_view, 0xe1c8, "Menu principale", (void *)AMIIBO_DETAIL_MENU_BACK_MAIN_MENU);
